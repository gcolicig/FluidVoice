...
final class VoiceEngineSettingsViewModel: ObservableObject {
    ...
    var modelDescriptionText: String {
        ...
        case .customOpenAICompatible:
            return "Custom Server sends recorded audio to any OpenAI-compatible /audio/transcriptions endpoint, such as a local oMLX server with your own Whisper model. Live preview uses the local Swiss German Q8 model when installed."
        case .whisperSwissGermanQ8:
            return "Whisper Swiss German runs a Q8-quantized Swiss German fine-tune of Whisper Large v3 fully offline via transcribe.cpp. It also powers the live preview of the Custom Server model."
        default:
